      ...
      try {
          ...
          const sellerEmailHtml = `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;">
              <div style="background:#111827;padding:30px;text-align:center;border-radius:16px 16px 0 0;">
                <h1 style="color:#f9fafb;margin:0;font-size:28px;">Funds Transferred</h1>
              </div>
              ...
              <div style="padding:40px;background:#0b0f14;color:#e5e7eb;border-radius:0 0 16px 16px;">
                ...
                <div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:25px;margin:25px 0;">
                  <h3 style="margin:0 0 20px 0;color:#e5e7eb;font-size:18px;">Transfer Details</h3>
                  <table style="width:100%;border-collapse:collapse;">
                    ...
                    <tr>
                      <td style="padding:10px 0;color:#94a3b8;font-size:14px;">Total Sale:</td>
                    ...
                    <tr>
                      <td style="padding:10px 0;color:#94a3b8;font-size:14px;">Transfer ID:</td>
                      <td style="padding:10px 0;color:#94a3b8;font-size:12px;text-align:right;">${transfer.id}</td>
                    </tr>
                  </table>
                </div>
                ...
                <div style="background:#0f172a;border-radius:12px;padding:20px;margin:25px 0;border:1px solid #1f2937;">
                  <p style="margin:0;color:#e5e7eb;font-size:14px;">
                    Funds typically appear in your Stripe balance within 1-2 business days.
                  </p>
                </div>
        ...
        if (transaction.buyer_email) {
          const buyerEmailHtml = `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;">
              <div style="background:#111827;padding:30px;text-align:center;border-radius:16px 16px 0 0;">
                <h1 style="color:#f9fafb;margin:0;font-size:28px;">Transfer Complete</h1>
              </div>
              ...
              <div style="padding:40px;background:#0b0f14;color:#e5e7eb;border-radius:0 0 16px 16px;">
                ...
                <p style="font-size:16px;color:#e5e7eb;line-height:1.6;margin:0 0 25px 0;">
                  The domain transfer for <strong>${transaction.domain_name}</strong> has been verified and completed.
                </p>
                
                <div style="background:#111827;border:1px solid #1f2937;border-radius:12px;padding:25px;margin:25px 0;text-align:center;">
                  <h2 style="margin:0;color:#10b981;">You now own ${transaction.domain_name}</h2>
                </div>
