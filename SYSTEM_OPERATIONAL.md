...
3. **Example:**
   ...
   - **Net platform revenue: $20.70 (2.07%)**

✅ **Sustainable margins:** After Stripe's ~2.9% processing fee, you keep ~2% net - perfect for long-term profitability!
...
SELECT 
  ...
  SUM(amount * 0.021) as estimated_net_revenue,
